			 ...
			 double& mixtureComponent)
{
  ...
  if (noise_mode ==0)
  {
    ...
    logEvidence = ComputeRobustLogEvidence(yValues, nCurrentItems, noiseFreeScale, noiseSigma, mixtureComponent);
  }
			 ...
			 double& mixtureComponent)
{
  ...
  //COMPUTE FIRST TERM
  fullCovarFunction = CubicSplineCovarianceFunction(blockSize, noiseFreeScale);
